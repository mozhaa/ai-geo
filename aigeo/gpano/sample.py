...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--phi", type=float, default=0, help="horizontal angle of camera ([-180, 180], 0=forward)")
    parser.add_argument("--theta", type=float, default=0, help="vertical angle of camera ([-90, 90], 0=forward)")
    parser.add_argument("--fov", type=float, default=0.5, help="FOV of camera ([0, 180])")
